...
tabla_confirmed <- read.csv('../../../../covid_htm/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv',header=TRUE,sep=",")
...
tabla_deaths <- read.csv('../../../../covid_htm/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv',header=TRUE,sep=",")
...
tabla_recovered <- read.csv('../../../../covid_htm/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recovered_global.csv',header=TRUE,sep=",")
